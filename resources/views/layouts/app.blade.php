<!DOCTYPE html>
<!-- Developed By Sidney Richards-0774935699 / 0713764301 -->
<html lang="en">
<head>
    <meta charset="utf-8" />
    <title>Farmers Registration Database</title>
        ...
        <div class="wrapper">
            ...
            <div class="left-side-menu left-side-menu-detached">
                <ul class="metismenu side-nav py-4">
                    ...
                    <li class="side-nav-title side-nav-item mt-2">Static Data</li>
                    <router-link to="/dashboard/addIndividual" class="side-nav-link"  active-class="text-primary">
                        <i class="uil-comment-alt-plus"></i>
                        <span> Add Record </span>
                    </router-link>
                    <li class="side-nav-title side-nav-item mt-2">Variable Data</li>
                    <router-link to="/dashboard/attachCrop" class="side-nav-link"  active-class="text-primary">
                        <i class="uil-trees"></i>
                        <span> Attach Crop/Season </span>
                    </router-link>
                    <router-link to="/dashboard/statsSelection" class="side-nav-link"  active-class="text-primary">
                        <i class="uil-scroll"></i>
                        <span> Provincial Statistics </span>
                    </router-link>
                    <router-link to="/dashboard/seasonalStats" class="side-nav-link"  active-class="text-primary">
                        <i class="uil-schedule"></i>
                        <span> Seasonal Statistics </span>
                    </router-link>
                    <li class="side-nav-title side-nav-item mt-2">System Settings</li>
                    <router-link to="/dashboard/accessUsers" class="side-nav-link"  active-class="text-primary">
                        <i class="uil-book-reader"></i>
                        <span> Roles Management </span>
                    </router-link>
                    <router-link to="/dashboard/systemReports" class="side-nav-link"  active-class="text-primary">
                        <i class="uil-rss"></i>
